...
const SocialLink = memo(({ icon: Icon, link, className }) => (
  <a href={link} target="_blank" rel="noopener noreferrer">
    <button className={`group relative p-3 ${className || ""}`}>
...
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind", "MongoDB","React Native"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Yash-Khadse" },
  { icon: Linkedin, link: "https://linkedin.com/in/yash-khadse-4yk" },
  { icon: Instagram, link: "https://www.instagram.com/_._yasssh/?hl=en", className: "mr-2" }, // Added className
];
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#030014] overflow-hidden" id="Home">
      ...
      >
        <div className="container mt-5 mx-auto px-[5%] sm:px-6 lg:px-[5%] min-h-screen">
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                <p
                  ...
                  data-aos-delay="1000"
                >
                  Crafting Innovative, Functional, and Intuitive Digital
